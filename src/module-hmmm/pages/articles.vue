<template>
  <div class='container'>
    ...
    <div class="articleslist">
     <ArticlesList @showVideoMask="showVideoMask" :showVideo="showVideo" element-loading-text="等我一下" v-loading="loading" @changeStates="changeStates"  :articlesList="articlesList" ></ArticlesList>
    </div>
   <!-- 分页 -->
